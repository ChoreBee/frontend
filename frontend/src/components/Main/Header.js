    ...
    return ( 
        <div className={ styles.headerBackground }>
          <div className={ styles.container }>
                 <Link to="/"><div className={ styles.logo }><div><img src="https://iili.io/HamlA67.png"
                    height={80}
                    width={300}/></div></div></Link>
            <div className={ styles.container }>
                <Link to="/"><div className={styles.brand}> Front page </div></Link>
            ...
            <div className="App">
              <div className='menu-container' ref={menuRef}>
                ...
                <div className={`dropdown-menu ${open? 'active' : 'inactive'}`} >
                  ...
                  <Link to="/"><text onClick={() => window.localStorage.clear()} >Log out</text></Link>
                </div>
              </div>
            </div>
          </div>
